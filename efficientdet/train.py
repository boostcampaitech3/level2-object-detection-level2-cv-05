...
parser.add_argument('--color-jitter', type=float, default=0.5, metavar='PCT',
...
parser.add_argument('--tta', type=int, default=2, metavar='N',
...
def create_datasets_and_loaders(
    ...
    """
    input_config = resolve_input_config(args, model_config=model_config) # input_config 파일 내부 
