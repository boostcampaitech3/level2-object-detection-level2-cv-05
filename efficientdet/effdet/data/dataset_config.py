...
class Coco2017Cfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='/opt/ml/detection/baseline/efficientdet-pytorch/custom_config/stratified_kfold_eff_oversampled/cv_train_1.json', img_dir='', has_labels=True),
        val=dict(ann_filename='/opt/ml/detection/baseline/efficientdet-pytorch/custom_config/stratified_kfold_eff_oversampled/cv_val_1.json', img_dir='', has_labels=True),
        test=dict(ann_filename='/opt/ml/detection/dataset/eff_test.json', img_dir='', has_labels=False),
    ))
