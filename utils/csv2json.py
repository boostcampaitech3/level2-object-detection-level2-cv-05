# efficientdet inference visualization
import pandas as pd 
import json
...
def csv_to_json(csv_file):
    ...
    file_names = csv_file['image_id'].values.tolist()
    bboxes = csv_file['PredictionString'].values.tolist()
...
if __name__ == "__main__":
    ...
    csv_file = pd.read_csv("/opt/ml/detection/baseline/efficientdet-pytorch/submission403_1.csv") # submission 파일 경로 설정 
    csv_to_json(csv_file)

'''
python data_viz.py -d ./dataset -a ./dataset/csv_to_json.json -p [포트번호] 
'''